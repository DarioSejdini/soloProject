...
def dashboard():
    ...
    pies = pie.get_all_Pies_By_User(data)
    return render_template('dashboard.html', pies = pies, loggedUser=loggedUser)
...
def pies():
    ...
    return render_template('pies.html', pies = pies, loggedUser=loggedUser)
